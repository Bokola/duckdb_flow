# DuckDB + Python: End-To-End Data Engineering 🐍

This is an accompying "do-it-yourself" as I go through data enginnering matrial from DuckDb. It is my initiative to learn how to to build data pipelines with **Python**, **SQL** & **DuckDB**. The first part is about ingestion, involving reading public data from Google Cloud, writing it locally as .csv or to MotherDuck database.
